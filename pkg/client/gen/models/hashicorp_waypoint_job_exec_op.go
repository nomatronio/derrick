...
// HashicorpWaypointJobExecOp Used to start a platform's exec function within a runner. This is only used
...
func (m *HashicorpWaypointJobExecOp) validateDeployment(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointJobExecOp) contextValidateDeployment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointJobExecOp) UnmarshalBinary(b []byte) error {
	var res HashicorpWaypointJobExecOp
