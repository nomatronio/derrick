...
// NomatronDerrickDeploymentPreload nomatron derrick deployment preload
//
// swagger:model nomatron.derrick.Deployment.Preload
type NomatronDerrickDeploymentPreload struct {
...
// Validate validates this nomatron derrick deployment preload
func (m *NomatronDerrickDeploymentPreload) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickDeploymentPreload) validateArtifact(formats strfmt.Registry) error {
...
func (m *NomatronDerrickDeploymentPreload) validateBuild(formats strfmt.Registry) error {
...
func (m *NomatronDerrickDeploymentPreload) validateJobDataSourceRef(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick deployment preload based on the context it is used
func (m *NomatronDerrickDeploymentPreload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickDeploymentPreload) contextValidateArtifact(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickDeploymentPreload) contextValidateBuild(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickDeploymentPreload) contextValidateJobDataSourceRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickDeploymentPreload) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickDeploymentPreload) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickDeploymentPreload
