...
// NomatronDerrickOnDemandRunnerConfig *******************************************************************
// OnDemand Runners
// ******************************************************************
//
// swagger:model nomatron.derrick.OnDemandRunnerConfig
type NomatronDerrickOnDemandRunnerConfig struct {

	// config format specifies the format of plugin_config
	ConfigFormat *NomatronDerrickHclFormat `json:"config_format,omitempty"`
...
// Validate validates this nomatron derrick on demand runner config
func (m *NomatronDerrickOnDemandRunnerConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickOnDemandRunnerConfig) validateConfigFormat(formats strfmt.Registry) error {
...
func (m *NomatronDerrickOnDemandRunnerConfig) validateTargetRunner(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick on demand runner config based on the context it is used
func (m *NomatronDerrickOnDemandRunnerConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickOnDemandRunnerConfig) contextValidateConfigFormat(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickOnDemandRunnerConfig) contextValidateTargetRunner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickOnDemandRunnerConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickOnDemandRunnerConfig) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickOnDemandRunnerConfig
