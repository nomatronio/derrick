...
func (m *HashicorpWaypointUpsertWorkspaceResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpWaypointUpsertWorkspaceResponse) contextValidateWorkspace(ctx context.Context, formats strfmt.Registry) error {
