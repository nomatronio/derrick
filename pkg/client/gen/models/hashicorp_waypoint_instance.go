...
// HashicorpWaypointInstance An instance is a single running process for a deployment. A deployment
...
func (m *HashicorpWaypointInstance) validateApplication(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointInstance) validateType(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointInstance) validateWorkspace(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointInstance) contextValidateApplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointInstance) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointInstance) contextValidateWorkspace(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointInstance) UnmarshalBinary(b []byte) error {
	var res HashicorpWaypointInstance
