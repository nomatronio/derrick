...
// NomatronDerrickRunner nomatron derrick runner
//
// swagger:model nomatron.derrick.Runner
type NomatronDerrickRunner struct {

	// The state of whether this runner is adopted or not.
	AdoptionState *NomatronDerrickRunnerAdoptionState `json:"adoption_state,omitempty"`
	...
	Components []*NomatronDerrickComponent `json:"components"`
	...
	// system in Derrick (see operations such as Deployment). For runners, they
	...
	Local NomatronDerrickRunnerLocal `json:"local,omitempty"`
	...
	Odr *NomatronDerrickRunnerODR `json:"odr,omitempty"`

	// True if this runner is currently online and connected.
	Online bool `json:"online,omitempty"`

	// remote indicates this is a "static" remote runner
	Remote NomatronDerrickRunnerRemote `json:"remote,omitempty"`
}

// Validate validates this nomatron derrick runner
func (m *NomatronDerrickRunner) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickRunner) validateAdoptionState(formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) validateComponents(formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) validateFirstSeen(formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) validateLastSeen(formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) validateOdr(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick runner based on the context it is used
func (m *NomatronDerrickRunner) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickRunner) contextValidateAdoptionState(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) contextValidateComponents(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) contextValidateOdr(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunner) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickRunner) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickRunner
