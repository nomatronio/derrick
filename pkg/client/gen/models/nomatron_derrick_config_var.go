...
// NomatronDerrickConfigVar ConfigVars represent configuration variables for applications and runners.
...
// are a way to parameterize a Derrick project/app. This is a different feature.
//
// == Conflict Resolution
//
...
type NomatronDerrickConfigVar struct {
	...
	// see a Derrick 0.5 or earlier git checkout.
	Application *NomatronDerrickRefApplication `json:"application,omitempty"`

	// dynamically sourced value
	Dynamic *NomatronDerrickConfigVarDynamicVal `json:"dynamic,omitempty"`
	...
	Target *NomatronDerrickConfigVarTarget `json:"target,omitempty"`
...
// Validate validates this nomatron derrick config var
func (m *NomatronDerrickConfigVar) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickConfigVar) validateApplication(formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) validateDynamic(formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) validateProject(formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) validateRunner(formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) validateTarget(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick config var based on the context it is used
func (m *NomatronDerrickConfigVar) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickConfigVar) contextValidateApplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) contextValidateDynamic(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) contextValidateProject(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) contextValidateRunner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) contextValidateTarget(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickConfigVar) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickConfigVar) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickConfigVar
