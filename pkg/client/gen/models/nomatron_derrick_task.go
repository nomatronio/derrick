...
// NomatronDerrickTask Task tracks the life of an on-demand runner task that spawns Start
...
type NomatronDerrickTask struct {
	...
	JobState *NomatronDerrickTaskState `json:"job_state,omitempty"`
	...
	// stop job
	StopJob *NomatronDerrickRefJob `json:"stop_job,omitempty"`
	...
	TaskJob *NomatronDerrickRefJob `json:"task_job,omitempty"`

	// watch_job will spawn a job to stream logs from the `task_job`.
	WatchJob *NomatronDerrickRefJob `json:"watch_job,omitempty"`
}

// Validate validates this nomatron derrick task
func (m *NomatronDerrickTask) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickTask) validateJobState(formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) validateStartJob(formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) validateState(formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) validateStopJob(formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) validateTaskJob(formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) validateWatchJob(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick task based on the context it is used
func (m *NomatronDerrickTask) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickTask) contextValidateJobState(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) contextValidateStartJob(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) contextValidateStopJob(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) contextValidateTaskJob(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) contextValidateWatchJob(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickTask) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickTask) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickTask
