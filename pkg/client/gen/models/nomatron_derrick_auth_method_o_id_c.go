...
// NomatronDerrickAuthMethodOIDC nomatron derrick auth method o ID c
//
// swagger:model nomatron.derrick.AuthMethod.OIDC
type NomatronDerrickAuthMethodOIDC struct {
...
// Validate validates this nomatron derrick auth method o ID c
func (m *NomatronDerrickAuthMethodOIDC) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this nomatron derrick auth method o ID c based on context it is used
func (m *NomatronDerrickAuthMethodOIDC) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NomatronDerrickAuthMethodOIDC) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickAuthMethodOIDC) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickAuthMethodOIDC
