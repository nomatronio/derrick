...
// NomatronDerrickInviteTokenRequest Passed with GenerateInviteToken with the params on how the invite token should
// be generate.
//
// swagger:model nomatron.derrick.InviteTokenRequest
type NomatronDerrickInviteTokenRequest struct {
...
// Validate validates this nomatron derrick invite token request
func (m *NomatronDerrickInviteTokenRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickInviteTokenRequest) validateLogin(formats strfmt.Registry) error {
...
func (m *NomatronDerrickInviteTokenRequest) validateSignup(formats strfmt.Registry) error {
...
func (m *NomatronDerrickInviteTokenRequest) validateUnusedEntrypoint(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick invite token request based on the context it is used
func (m *NomatronDerrickInviteTokenRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickInviteTokenRequest) contextValidateLogin(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickInviteTokenRequest) contextValidateSignup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickInviteTokenRequest) contextValidateUnusedEntrypoint(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickInviteTokenRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickInviteTokenRequest) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickInviteTokenRequest
