...
func (m *HashicorpWaypointUpsertApplicationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpWaypointUpsertApplicationResponse) validateApplication(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointUpsertApplicationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpWaypointUpsertApplicationResponse) contextValidateApplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointUpsertApplicationResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpWaypointUpsertApplicationResponse
