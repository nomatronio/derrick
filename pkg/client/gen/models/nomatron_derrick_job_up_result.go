...
// NomatronDerrickJobUpResult UpResult is the result of an UpOp. Because "up" calls other operations,
// the Result message will set the build, deploy, push, and release results.
//
// swagger:model nomatron.derrick.Job.UpResult
type NomatronDerrickJobUpResult struct {
...
// Validate validates this nomatron derrick job up result
func (m *NomatronDerrickJobUpResult) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this nomatron derrick job up result based on context it is used
func (m *NomatronDerrickJobUpResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NomatronDerrickJobUpResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickJobUpResult) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickJobUpResult
