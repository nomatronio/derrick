...
func (m *HashicorpWaypointListJobsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpWaypointListJobsResponse) validateJobs(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointListJobsResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointListJobsResponse) contextValidateJobs(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointListJobsResponse) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointListJobsResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpWaypointListJobsResponse
