...
// NomatronDerrickGeneration Generation is a shared message type used by operations to denote the
...
// reuse a generation.
//
// The concept of a "Generation" was introduced in Derrick 0.4. Operations
...
type NomatronDerrickGeneration struct {

	// Id is the unique identifier for this generation. This value is opaque.
	// Derrick internally only requires that two different generations have
...
// Validate validates this nomatron derrick generation
func (m *NomatronDerrickGeneration) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this nomatron derrick generation based on context it is used
func (m *NomatronDerrickGeneration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NomatronDerrickGeneration) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickGeneration) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickGeneration
