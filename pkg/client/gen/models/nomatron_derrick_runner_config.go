...
// NomatronDerrickRunnerConfig nomatron derrick runner config
//
// swagger:model nomatron.derrick.RunnerConfig
type NomatronDerrickRunnerConfig struct {
	...
	// them.
	ConfigVars []*NomatronDerrickConfigVar `json:"config_vars"`
}

// Validate validates this nomatron derrick runner config
func (m *NomatronDerrickRunnerConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickRunnerConfig) validateConfigSources(formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunnerConfig) validateConfigVars(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick runner config based on the context it is used
func (m *NomatronDerrickRunnerConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickRunnerConfig) contextValidateConfigSources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunnerConfig) contextValidateConfigVars(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickRunnerConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickRunnerConfig) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickRunnerConfig
