...
// NomatronDerrickPipeline nomatron derrick pipeline
//
// swagger:model nomatron.derrick.Pipeline
type NomatronDerrickPipeline struct {
	...
	Steps map[string]NomatronDerrickPipelineStep `json:"steps,omitempty"`
}

// Validate validates this nomatron derrick pipeline
func (m *NomatronDerrickPipeline) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickPipeline) validateProject(formats strfmt.Registry) error {
...
func (m *NomatronDerrickPipeline) validateSteps(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick pipeline based on the context it is used
func (m *NomatronDerrickPipeline) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickPipeline) contextValidateProject(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickPipeline) contextValidateSteps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickPipeline) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickPipeline) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickPipeline
