...
// NomatronDerrickJobAuthResultResult nomatron derrick job auth result result
//
// swagger:model nomatron.derrick.Job.AuthResult.Result
type NomatronDerrickJobAuthResultResult struct {
...
// Validate validates this nomatron derrick job auth result result
func (m *NomatronDerrickJobAuthResultResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickJobAuthResultResult) validateAuthError(formats strfmt.Registry) error {
...
func (m *NomatronDerrickJobAuthResultResult) validateCheckError(formats strfmt.Registry) error {
...
func (m *NomatronDerrickJobAuthResultResult) validateComponent(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick job auth result result based on the context it is used
func (m *NomatronDerrickJobAuthResultResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickJobAuthResultResult) contextValidateAuthError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickJobAuthResultResult) contextValidateCheckError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickJobAuthResultResult) contextValidateComponent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickJobAuthResultResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickJobAuthResultResult) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickJobAuthResultResult
