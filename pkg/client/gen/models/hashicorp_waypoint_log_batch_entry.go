...
func (m *HashicorpWaypointLogBatchEntry) validateSource(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointLogBatchEntry) validateTimestamp(formats strfmt.Registry) error {
...
func (m *HashicorpWaypointLogBatchEntry) contextValidateSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointLogBatchEntry) UnmarshalBinary(b []byte) error {
	var res HashicorpWaypointLogBatchEntry
