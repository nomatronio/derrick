...
// NomatronDerrickServerConfig ServerConfig is the configuration for the server that can be read and
...
type NomatronDerrickServerConfig struct {
	...
	AdvertiseAddrs []*NomatronDerrickServerConfigAdvertiseAddr `json:"advertise_addrs"`
...
// Validate validates this nomatron derrick server config
func (m *NomatronDerrickServerConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickServerConfig) validateAdvertiseAddrs(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick server config based on the context it is used
func (m *NomatronDerrickServerConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickServerConfig) contextValidateAdvertiseAddrs(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickServerConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickServerConfig) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickServerConfig
