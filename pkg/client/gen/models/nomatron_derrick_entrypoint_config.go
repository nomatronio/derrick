...
// NomatronDerrickEntrypointConfig nomatron derrick entrypoint config
//
// swagger:model nomatron.derrick.EntrypointConfig
type NomatronDerrickEntrypointConfig struct {
	...
	Deployment *NomatronDerrickEntrypointConfigDeploymentInfo `json:"deployment,omitempty"`

	// The environment variables to set in the entrypoint.
	EnvVars []*NomatronDerrickConfigVar `json:"env_vars"`

	// Exec are requested exec sessions for this instance.
	Exec []*NomatronDerrickEntrypointConfigExec `json:"exec"`
	...
	URLService *NomatronDerrickEntrypointConfigURLService `json:"url_service,omitempty"`
}

// Validate validates this nomatron derrick entrypoint config
func (m *NomatronDerrickEntrypointConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickEntrypointConfig) validateConfigSources(formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) validateDeployment(formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) validateEnvVars(formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) validateExec(formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) validateURLService(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick entrypoint config based on the context it is used
func (m *NomatronDerrickEntrypointConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickEntrypointConfig) contextValidateConfigSources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) contextValidateDeployment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) contextValidateEnvVars(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) contextValidateExec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) contextValidateURLService(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickEntrypointConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickEntrypointConfig) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickEntrypointConfig
