...
// NomatronDerrickValidateJobResponse nomatron derrick validate job response
//
// swagger:model nomatron.derrick.ValidateJobResponse
type NomatronDerrickValidateJobResponse struct {
...
// Validate validates this nomatron derrick validate job response
func (m *NomatronDerrickValidateJobResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickValidateJobResponse) validateValidationError(formats strfmt.Registry) error {
...
// ContextValidate validate this nomatron derrick validate job response based on the context it is used
func (m *NomatronDerrickValidateJobResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NomatronDerrickValidateJobResponse) contextValidateValidationError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NomatronDerrickValidateJobResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NomatronDerrickValidateJobResponse) UnmarshalBinary(b []byte) error {
	var res NomatronDerrickValidateJobResponse
