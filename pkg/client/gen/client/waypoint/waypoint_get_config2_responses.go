...
func (o *WaypointGetConfig2OK) Error() string {
	return fmt.Sprintf("[GET /project/{project.project}/config][%d] waypointGetConfig2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetConfig2Default) Error() string {
	return fmt.Sprintf("[GET /project/{project.project}/config][%d] Waypoint_GetConfig2 default  %+v", o._statusCode, o.Payload)
}
