...
func (o *WaypointGetLatestBuild2OK) Error() string {
	return fmt.Sprintf("[GET /project/{application.project}/application/{application.application}/workspace/{workspace.workspace}/build/latest][%d] waypointGetLatestBuild2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetLatestBuild2Default) Error() string {
	return fmt.Sprintf("[GET /project/{application.project}/application/{application.application}/workspace/{workspace.workspace}/build/latest][%d] Waypoint_GetLatestBuild2 default  %+v", o._statusCode, o.Payload)
}

func (o *WaypointGetLatestBuild2Default) String() string {
	return fmt.Sprintf("[GET /project/{application.project}/application/{application.application}/workspace/{workspace.workspace}/build/latest][%d] Waypoint_GetLatestBuild2 default  %+v", o._statusCode, o.Payload)
}
