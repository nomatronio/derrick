...
func (o *WaypointUpsertTriggerOK) Error() string {
	return fmt.Sprintf("[POST /triggers][%d] waypointUpsertTriggerOK  %+v", 200, o.Payload)
}
...
func (o *WaypointUpsertTriggerDefault) Error() string {
	return fmt.Sprintf("[POST /triggers][%d] Waypoint_UpsertTrigger default  %+v", o._statusCode, o.Payload)
}
