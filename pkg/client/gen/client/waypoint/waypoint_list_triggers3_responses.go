...
func (o *WaypointListTriggers3OK) Error() string {
	return fmt.Sprintf("[GET /project/{application.project}/application/{application.application}/triggers][%d] waypointListTriggers3OK  %+v", 200, o.Payload)
}
...
func (o *WaypointListTriggers3Default) Error() string {
	return fmt.Sprintf("[GET /project/{application.project}/application/{application.application}/triggers][%d] Waypoint_ListTriggers3 default  %+v", o._statusCode, o.Payload)
}

func (o *WaypointListTriggers3Default) String() string {
	return fmt.Sprintf("[GET /project/{application.project}/application/{application.application}/triggers][%d] Waypoint_ListTriggers3 default  %+v", o._statusCode, o.Payload)
}
