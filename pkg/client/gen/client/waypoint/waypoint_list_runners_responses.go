...
func (o *WaypointListRunnersOK) Error() string {
	return fmt.Sprintf("[GET /runners][%d] waypointListRunnersOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListRunnersDefault) Error() string {
	return fmt.Sprintf("[GET /runners][%d] Waypoint_ListRunners default  %+v", o._statusCode, o.Payload)
}
