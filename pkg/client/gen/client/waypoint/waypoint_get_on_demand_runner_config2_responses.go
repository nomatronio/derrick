...
func (o *WaypointGetOnDemandRunnerConfig2OK) IsSuccess() bool {
	return true
}
...
func (o *WaypointGetOnDemandRunnerConfig2OK) IsCode(code int) bool {
	return code == 200
}

func (o *WaypointGetOnDemandRunnerConfig2OK) Error() string {
	return fmt.Sprintf("[GET /on-demand-runner/by-name/{config.name}][%d] waypointGetOnDemandRunnerConfig2OK  %+v", 200, o.Payload)
}

func (o *WaypointGetOnDemandRunnerConfig2OK) String() string {
	return fmt.Sprintf("[GET /on-demand-runner/by-name/{config.name}][%d] waypointGetOnDemandRunnerConfig2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetOnDemandRunnerConfig2Default) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this waypoint get on demand runner config2 default response has a 3xx status code
func (o *WaypointGetOnDemandRunnerConfig2Default) IsRedirect() bool {
...
func (o *WaypointGetOnDemandRunnerConfig2Default) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *WaypointGetOnDemandRunnerConfig2Default) Error() string {
	return fmt.Sprintf("[GET /on-demand-runner/by-name/{config.name}][%d] Waypoint_GetOnDemandRunnerConfig2 default  %+v", o._statusCode, o.Payload)
}

func (o *WaypointGetOnDemandRunnerConfig2Default) String() string {
	return fmt.Sprintf("[GET /on-demand-runner/by-name/{config.name}][%d] Waypoint_GetOnDemandRunnerConfig2 default  %+v", o._statusCode, o.Payload)
}
