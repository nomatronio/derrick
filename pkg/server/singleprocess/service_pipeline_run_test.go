...
func TestServicePipelineRun(t *testing.T) {
	...
	t.Run("get latest", func(t *testing.T) {
		...
		require.NoError(err)
		require.Equal(latest.PipelineRun.Sequence, runs.PipelineRuns[1].Sequence)
		require.Equal(latest.PipelineRun.Sequence, uint64(2))
		...
		require.NoError(err)
		require.Equal(latest.PipelineRun.Sequence, runs.PipelineRuns[2].Sequence)
		require.Equal(latest.PipelineRun.Sequence, uint64(3))
	})
}
