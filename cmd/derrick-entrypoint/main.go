...
import (
	...
	"github.com/nomatronio/derrick/internal/ceb"
	cebssh "github.com/nomatronio/derrick/internal/ceb/ssh"
	"github.com/nomatronio/derrick/internal/pkg/signalcontext"
	ssh "github.com/nomatronio/derrick/internal/ssh"
)
...
func realMain() int {
	...
	// If DERRICK_EXEC_PLUGIN_SSH is set, then the entrypoint is being launched
