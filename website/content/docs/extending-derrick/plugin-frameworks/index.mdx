...
Package `framework` contains a high-level framework for writing Derrick plugins.
...
functions depending on what operations are being taken with Derrick.

https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/framework/resource

# Implementing Resource Manager

The Derrick Plugin SDK Framework is used to implement Resource Manager for your
...
option go_package = "github.com/nomatronio/derrick/template/platform";
...
```go
// Resource manager will tell the Derrick Plugin SDK how to create and delete
// certain resources for your deployments.
//
// For example, your deployment might need to create a "container" or "load balancer".
// Your plugin could implement two resources through ResourceManager and the Derrick
...
a real platform plugin, check out how Derrick handles Resource Manager
with the Kubernetes plugin for deployments and releases:

- [Derrick Kubernetes Deploy Plugin](https://github.com/nomatronio/derrick/blob/main/builtin/k8s/platform.go)
- [Derrick Kubernetes Release Plugin](https://github.com/nomatronio/derrick/blob/main/builtin/k8s/releaser.go)
