...
[Default Parameters](/derrick/docs/extending-derrick/plugin-interfaces/default-parameters) documentation.
...
[specific documentation](/derrick/docs/extending-derrick/passing-values).
...
[Next - Compiling the Plugin](/derrick/docs/extending-derrick/creating-plugins/compiling)
