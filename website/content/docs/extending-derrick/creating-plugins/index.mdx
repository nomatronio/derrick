...
- [Example Code](https://github.com/nomatronio/derrick)
...
```shell
./clone.sh gobuilder ../gobuilder github.com/nomatronio/derrick/gobuilder
...
Compile Plugin
go build -o ./bin/derrick-plugin-template ./main.go
```

If you received an error when trying to build your plugin, double-check that you have all the required pre-requisites
installed.

[Next - Registering Plugin Components](/derrick/docs/extending-derrick/creating-plugins/main)
