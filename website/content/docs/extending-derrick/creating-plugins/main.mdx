...
A Derrick plugin is just a Go binary; if you look at `main.go` you will see the `main` function. The `sdk.Main`
function sets up the Derrick SDK and registers the interfaces for the go-plugin system for you. All you need to do is
...
[Next - Handling Configuration](/waypoint/docs/extending-derrick/creating-plugins/configuration)
