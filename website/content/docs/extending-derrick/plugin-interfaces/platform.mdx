...
page_title: 'Platform'
description: |-
  How to implement the Platform component for a Derrick plugin
---

# Platform

https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#Platform

The `Platform` component is where you handle interaction between Derrick and the destination platform. It is handled
through the implementation of the DeployFunc interface and optionally the `PlatformReleaser` interface.

![Platform](/img/extending-derrick/platform.png)
...
which you return a function which will be called by Derrick.
