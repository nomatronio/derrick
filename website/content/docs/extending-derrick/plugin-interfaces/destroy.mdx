...
page_title: 'Destroy'
description: |-
  How to implement the Destroy component for a Derrick plugin
---

# Destroy

https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#Destroyer

The `Destroyer` interface is responsible for removing any resources which have been created by the derrick `deploy`
and `release` phase.

![Platform](/img/extending-derrick/destroy.png)
...
`DestroyFunc` requires you return a function, like other interface functions Derrick will automatically inject any of the
