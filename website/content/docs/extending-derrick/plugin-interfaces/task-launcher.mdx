...
The `TaskLauncher` component makes possible launching Derrick [On-Demand Runners](/waypoint/docs/runner/on-demand-runner)
...
with the [`derrick job get-stream` command](/waypoint/commands/job-get-stream).
