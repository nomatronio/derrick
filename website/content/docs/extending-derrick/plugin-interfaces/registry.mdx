...
page_title: 'Registry'
description: |-
  How to implement the Registry component for a Derrick plugin
---

# Registry

https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#Registry
...
later stage of the Derrick lifecycle.
