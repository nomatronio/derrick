...
description: |-
  Default parameters for Derrick plugin component methods
---

# Default Parameters

In addition to user defined return values you can also request derrick injects default parameters.
...
Context is a default parameter and is used by Derrick to notify you when the work that component is
...
to notify you when Derrick cancels the current operation.
...
https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#Source

Source is a data struct which provides the current application name `App`, and `Path` which is the directory
containing the current Derrick file.
...
https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#JobInfo
...
https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#DeploymentConfig
...
Logger provides you with the ability to write to the Derrick standard logger using different log levels such as
Info, Debug, Trace, etc. By default, log output is disabled when running a derrick command. The environment variable
...
https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/terminal#UI
...
https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#LabelSet

LabelSet allows you to read the labels defined at an app level on your Derrick configuration.
