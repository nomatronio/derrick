...
description: |-
  How to implement the ReleaseManager component for a Derrick plugin
---

# ReleaseManager

https://pkg.go.dev/github.com/nomatronio/derrick-plugin-sdk/component#ReleaseManager
...
![Release Manager](/img/extending-derrick/release-manager.png)
...
`ReleaseManager` has a single method which you must implement which returns a function called by Derrick.
...
are a Derrick value and an error.
