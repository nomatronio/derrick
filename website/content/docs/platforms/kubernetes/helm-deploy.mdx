...
1. **Dynamic Chart values.** Derrick makes it easy to set chart values
   ...
   information using [HCL functions](/waypoint/docs/derrick-hcl/functions/all).
...
4. **Other Derrick features.** You can take advantage of other Derrick features such as [remote operations](/waypoint/docs/derrick-hcl/functions/all),
   [logs](/waypoint/docs/logs), [exec](/waypoint/docs/exec), [input variables](/waypoint/docs/derrick-hcl/variables/input), and more.
...
[here for more information on artifact variables](/waypoint/docs/derrick-hcl/variables/artifact)). Notice that with the
...
If you want to use the [Derrick entrypoint](/waypoint/docs/entrypoint) functionality,
...
as [`entrypoint.env`](/waypoint/docs/derrick-hcl/variables/entrypoint). This can be
...
A full example is available [in the `derrick-examples` repository](https://github.com/hashicorp/waypoint-examples/tree/main/kubernetes/nodejs-helm),
