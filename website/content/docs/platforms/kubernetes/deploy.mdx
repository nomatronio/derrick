...
[Helm](/waypoint/docs/platforms/kubernetes/helm-deploy) and raw
[`kubectl apply`](/waypoint/docs/platforms/kubernetes/kubectl-deploy) as first-class
...
By configuring a `kubernetes` [release stanza](/waypoint/docs/derrick-hcl/release),
