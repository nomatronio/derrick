...
Derrick incorporates a first-class [build](/waypoint/docs/lifecycle/build) step that
...
[derrick.hcl file](/waypoint/docs/derrick-hcl).

-> **The built-in build functionality is optional.** If you have an external
process already setup to build your images, you can
[use externally-built images](/waypoint/docs/platforms/kubernetes/external-build). Derrick
...
found on the [build lifecycle page](/waypoint/docs/lifecycle/build).
...
take a look at the [`pack` builder](/waypoint/docs/lifecycle/build#cloud-native-buildpacks).
...
[input variables](/waypoint/docs/derrick-hcl/variables/input) paired with
...
[many different ways](/waypoint/docs/derrick-hcl/variables/input#assigning-values-to-custom-input-variables). For long term use, the recommended location to set the variable
...
[`registry` stanza](/waypoint/docs/derrick-hcl/registry) for specifying a
...
[input variables](/waypoint/docs/derrick-hcl/variables/input) to parameterize them.
...
See [runner configuration](/waypoint/docs/runner/config) for details.
...
[certain conditions](/waypoint/docs/projects/remote#requirements) are met.
