...
`data_source` stanza in the `runner` stanza in the [derrick.hcl file](/waypoint/docs/derrick-hcl/runner).
...
[how to configure the Git data source using the CLI or web UI here](/waypoint/docs/derrick-hcl/runner#cli-or-ui-configuration).
...
[derrick project apply](/waypoint/commands/project-apply#waypoint-project-apply)
...
on the [`derrick project apply`](/waypoint/commands/project-apply#poll) command.
