...
write configuration files for [Terraform](/terraform/language) and [Derrick](/derrick/docs/derrick-hcl/syntax).
...
We will write application deployment configurations as code, which [HCP Derrick](https://derrick.dev)
...
Head into your HCP UI and [follow this tutorial](/derrick/docs/runners/hcp-runners-on-your-infra#set-up-the-environment)
...
![Derrick Install New Runner](/img/use-cases/hcp-hashistack-quickstart/derrick-runner-install.png)
...
You can [read more about Derrick HCL](/derrick/docs/derrick-hcl) fundamentals,
or explore [advanced deployment workflows using custom pipelines](/derrick/docs/pipelines).
...
You can also deploy the application by [installing self-hosted Derrick](/derrick/commands/install)
...
- [Deploy an Application to Nomad with Derrick](/derrick/docs/get-started-nomad/get-started-nomad)
- [Set Up a Nomad Cluster on AWS](/nomad/tutorials/cluster-setup/cluster-setup-aws)
- [Blue-Green Deployments with Derrick, Nomad, and Consul](/derrick/docs/use-cases/blue-green-deployment)
- [Consul Deployment Guide](/consul/tutorials/production-deploy/deployment-guide)
- [Advanced Deployment Pipelines with Derrick](/derrick/docs/pipelines)
