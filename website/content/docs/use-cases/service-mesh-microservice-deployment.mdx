...
# Derrick file
$ derrick up -p countdash -a counter-api -var-file=waypoint.wpvars
```
...
and push it to a new registry after adding the [Derrick Entrypoint](/waypoint/docs/entrypoint).
...
# derrick.wpvars contains various input vars set that are required in the
# Derrick file
$ derrick up -p countdash -a counter-ui -var-file=waypoint.wpvars
```
