...
The [HashiCorp Vault plugin for Derrick](/waypoint/integrations/hashicorp/vault)
...
does this, see the [Derrick Entrypoint docs](/waypoint/docs/entrypoint).
...
- [Derrick dynamic app configuration](/waypoint/docs/app-config/dynamic)
- [Derrick dynamic variables](/waypoint/docs/derrick-hcl/variables/dynamic)
