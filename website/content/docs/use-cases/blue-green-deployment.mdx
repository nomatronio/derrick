...
or automated through scripts or some other means; but [Derrick pipelines](/derrick/docs/pipelines)
...
![Blue Deployment in Derrick](/img/use-cases/blue-green-deployment/blue-deployment-derrick-ui.png)
...
the [Derrick documentation on config variables](/derrick/docs/derrick-hcl/config).
...
- [Derrick Pipelines](/derrick/docs/pipelines)
- [Derrick Plugins](/derrick/docs/plugins)
