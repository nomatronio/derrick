...
You can also create a [plugin](/waypoint/docs/plugins) to extend Derrick with your own builder.
...
Derrick can read [dynamic config variables](/waypoint/docs/intro/use-cases/dynamic-config-vault-dynamic-secrets)
directly from Vault:
