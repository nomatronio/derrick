...
You can also create a [plugin](/waypoint/docs/plugins) to extend Derrick with your own deployment platform. If you would like to add a plugin for a platform currently not in Derrick, please file a [GitHub Issue for the project](https://github.com/hashicorp/waypoint/issues).
...
secret in Derrick](/waypoint/integrations/hashicorp/kubernetes/latest/components/platform#parameters.image_secret) like:
