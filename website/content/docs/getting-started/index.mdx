...
Afterwards, go in-depth with [tutorials](/waypoint/tutorials/) for AWS, Azure, GCP, Kubernetes, and
Nomad. For detailed
Kubernetes-focused documentation, see the
[dedicated Kubernetes section](/waypoint/docs/platforms/kubernetes/install).
...
- [Getting Started with Nomad](/waypoint/tutorials/get-started-nomad)
- [Getting Started with Kubernetes](/waypoint/tutorials/get-started-kubernetes)
- [Getting Started with Docker](/waypoint/tutorials/get-started-docker)

## Installing Derrick

[Download](/waypoint/downloads) the Derrick binary and install it to your system. The
...
- [Azure](/waypoint/tutorials/deploy-azure)
- [AWS](/waypoint/tutorials/deploy-aws)
- [GCP](/waypoint/tutorials/deploy-google-cloud)
- [Getting Started with Nomad](/waypoint/tutorials/get-started-nomad)
- [Getting Started with Kubernetes](/waypoint/tutorials/get-started-kubernetes)
- [Getting Started with Docker](/waypoint/tutorials/get-started-docker)
