...
[setting up OIDC](/derrick/docs/server/auth/oidc).
...
[derrick login](/derrick/commands/login) command. Specify the address to the
...
For tokens, use the
[derrick user invite](/derrick/commands/user-invite) CLI command with
