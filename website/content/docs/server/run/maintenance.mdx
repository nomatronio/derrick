...
To backup the database, use the [`derrick server snapshot`](/waypoint/commands/server-snapshot)
...
You can then restore this snapshot using [`derrick server restore`](/waypoint/commands/server-restore).
