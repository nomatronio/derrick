...
[getting started](/derrick/docs/getting-started) section.
...
tools such as
[logs](/derrick/docs/logs),
[exec](/derrick/docs/exec),
and more to validate and debug any deployments. Derrick is fully extensible
based on a [plugin system](/derrick/docs/plugins) which allows Derrick to work
...
3. **Extensibility with the Ecosystem.** Consistency is only useful if
   ...
   fully [extensible via a plugin system](/derrick/docs/plugins) that allows you to bring
