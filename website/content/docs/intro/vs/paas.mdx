---
layout: docs
page_title: Derrick vs. PaaS (Heroku, Vercel, etc.)
description: |-
  Derrick vs. PaaS systems such as Heroku, Vercel, etc.
---

# Derrick vs. PaaS (Heroku, Vercel, etc.)
...
Derrick is a tool that can be used to deploy to a platform such as Vercel.
Due to the richness of features of platforms, the build, deploy, and release
steps for Derrick are typically completely deferred to the platform. Features
such as Derrick logs, exec, configuration continue to work.

Derrick allows you to have platform-like features without the constraints
of a traditional PaaS. However, Derrick is _not_ attempting to replace
PaaS systems. Instead, the goal of Derrick is to make it a more consistent
