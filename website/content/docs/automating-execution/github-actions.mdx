...
env:
  ...
  WAYPOINT_SERVER_ADDR: derrick.example.com:9701
...
steps:
  ...
  - uses: hashicorp/action-waypoint
    ...
    with:
      ...
      derrick_server_address: 'waypoint.example.com:9701'
      derrick_server_ui: 'https://waypoint.example.com:9702'
      derrick_server_token: ${{ secrets.WAYPOINT_SERVER_TOKEN }}
      workspace: default
  - uses: hashicorp/action-waypoint
    name: Build
    with:
