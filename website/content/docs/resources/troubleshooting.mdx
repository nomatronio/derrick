...
[`derrick install`]: /waypoint/commands/install
...
[entrypoint](/waypoint/docs/entrypoint) if it is in use.
...
[entrypoint logs](/waypoint/docs/entrypoint#logging) for more information.
