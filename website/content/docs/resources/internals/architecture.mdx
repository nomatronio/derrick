...
all [entrypoint-required functionality](/derrick/docs/entrypoint#functionality).
...
- **Server** - The Derrick server is a long-running, central service that
  ...
  Learn more about [servers here](/derrick/docs/server).
...
- **Entrypoint** - The [Derrick Entrypoint](/derrick/docs/entrypoint) is built-in to
...
- **Restarting deployments with an entrypoint** _may not_ be affected.
  ...
  start the subprocess. If you use [application configuration](/derrick/docs/app-config),
...
See [CLI acts as a runner](/derrick/docs/resources/internals/execution) for more details.
