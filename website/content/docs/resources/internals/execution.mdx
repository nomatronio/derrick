...
description: |-
  This page documents how operations such as build, deploy, and release execute within Derrick. This helps explain what components need access to what systems and how information flows within Derrick.
---

# Operation Execution

This page documents how operations such as build, deploy, and release
execute within Derrick. This helps explain what components need access to
what systems and how information flows within Derrick.

Operation execution in Derrick always flows through three components: the
...
To improve the user experience, Derrick simplifies what is required and
...
In some cases, you use a CLI directly with a Derrick server where there is no
