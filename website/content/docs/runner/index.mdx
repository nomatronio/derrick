...
[`derrick runner agent`](/waypoint/commands/runner-agent) that is configured with the details
...
The [`derrick install`](/waypoint/commands/install) and [`derrick runner install`](/waypoint/commands/runner-install)
...
`-runner=false` flag to the [`derrick install`](/waypoint/commands/install) command.
