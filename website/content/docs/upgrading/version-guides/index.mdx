...
description: |-
  This section contains upgrade guides for specific Derrick versions.
---
...
use `derrick server snapshot` to capture a server snapshot prior to upgrading.
For prior versions, you'll have to manually [copy the database file](/derrick/docs/server/run/maintenance#path-to-database).
