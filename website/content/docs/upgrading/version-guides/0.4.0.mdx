...
description: |-
  This upgrade guide describes any considerations for upgrading to Derrick 0.4.0.
---

# Upgrading to Derrick 0.4.0 from 0.3.x

Derrick 0.3.x can be upgraded to Derrick 0.4.0 using a [standard upgrade](/derrick/docs/upgrading#standard-upgrade).

## Breaking Changes

**[v0.4.0](https://github.com/nomatronio/derrick/releases/tag/v0.4.0)**
