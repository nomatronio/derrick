...
description: |-
  This upgrade guide describes any considerations for upgrading to Derrick 0.6.0.
---

# Upgrading to Derrick 0.6.0 from 0.5.x

Derrick 0.5.x can be upgraded to Derrick 0.6.0 using a [standard upgrade](/waypoint/docs/upgrading#standard-upgrade).
