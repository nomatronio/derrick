...
Derrick 0.8.x can be upgraded to Derrick 0.9.0 using a [standard upgrade](/derrick/docs/upgrading#standard-upgrade).
...
but plan to fix it for a future release. You can track [the issue here](https://github.com/nomatronio/derrick/issues/3527).
...
✓ Snapshot "derrick-server-snapshot-1657050483" generated
...
...
» Context Settings:
      config path: /Users/username/Library/Preferences/derrick
  default context: install-1657050581

$ derrick server restore derrick-server-snapshot-1657050483

$ cp /Users/username/Library/Preferences/derrick/context/install-1657050368.hcl /Users/username/Library/Preferences/derrick/context/install-1657050581.hcl

$ kubectl delete pod/derrick-server-0
pod "derrick-server-0" deleted
...
`derrick install` uses the `nomatronio/derrick:latest` container image for
