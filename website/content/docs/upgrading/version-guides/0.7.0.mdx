...
description: |-
  This upgrade guide describes any considerations for upgrading to Derrick 0.7.0.
---

# Upgrading to Derrick 0.7.0 from 0.6.x

Derrick 0.6.x can be upgraded to Derrick 0.7.0 using a [standard upgrade](/derrick/docs/upgrading#standard-upgrade).

## Breaking Changes

**[v0.7.0](https://github.com/nomatronio/derrick/releases/tag/v0.7.0)**
...
- plugin/docker: `img`-based Dockerless builds are no longer supported.
  ...
  runners that shipped in Derrick 0.6. Static runners without access to
