...
description: |-
  This upgrade guide describes any considerations for upgrading to Derrick 0.3.0.
---

# Upgrading to Derrick 0.3.0 from 0.2.x

Derrick 0.2.x can be upgraded to Derrick 0.3.0 using a [standard upgrade](/derrick/docs/upgrading#standard-upgrade).

## Breaking Changes

**[v0.3.0](https://github.com/nomatronio/derrick/releases/tag/v0.3.0)**

- ui: dropped support for Internet Explorer

**[v0.3.2](https://github.com/nomatronio/derrick/releases/tag/v0.3.2)**
...
```shell-session
$ ./derrick token exchange abcd1234 -v
2020-12-10T10:48:33.951-0800 [INFO]  derrick: derrick version: full_string="Derrick v0.3.0 (5db76632)" version=v0.3.0 prerelease= metadata= revision=5db76632
2020-12-10T10:48:33.951-0800 [INFO]  derrick.server: attempting to source credentials and connect
2020-12-10T10:48:33.980-0800 [INFO]  derrick: server version info: version=v0.3.0-177-ed413ab93 api_min=1 api_current=1 entrypoint_min=1 entrypoint_current=1
