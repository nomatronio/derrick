...
via the [derrick config CLI](/waypoint/docs/app-config#setting-configuration-via-the-cli).
...
The Derrick entrypoint can be [completely disabled](/waypoint/docs/entrypoint/disable)
