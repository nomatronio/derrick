...
Function documentation pages may use [placement tables](/derrick/docs/derrick-hcl#placement-tables)
...
For a complete list of variables, see [variables](/derrick/docs/derrick-hcl/variables)
