...
Template syntax uses HCL [string templates](/derrick/docs/derrick-hcl/syntax/expressions#string-templates).
...
with [`file`](/derrick/docs/derrick-hcl/functions/all#file).
