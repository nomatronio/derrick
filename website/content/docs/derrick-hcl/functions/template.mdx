---
layout: docs
page_title: Templating - Functions - derrick.hcl
description: |-
  Derrick has a set of functions for templating strings, files, and directories with both predefined and custom variable values. These templates can use conditionals, loops, and more to dynamically generate content.
---

# Templating Functions

Derrick has a set of functions for templating strings, files, and directories
...
Derrick has three templating functions documented below: `templatefile`,
...
Template syntax uses HCL [string templates](/waypoint/docs/derrick-hcl/syntax/expressions#string-templates).
...
with [`file`](/waypoint/docs/derrick-hcl/functions/all#file).
