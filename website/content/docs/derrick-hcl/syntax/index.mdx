...
[expressions](/derrick/docs/derrick-hcl/syntax/expressions) which allow the value to
...
sidebar to the left. The documentation uses [placement tables](/derrick/docs/derrick-hcl#placement-tables)
