...
- Maps/objects are represented by a pair of curly braces containing a series of
  ...
  they are a valid [identifier](/derrick/docs/derrick-hcl/syntax#identifiers), but must be quoted
...
[built-in functions](/derrick/docs/derrick-hcl/functions) that can be used
...
[the function reference](/derrick/docs/derrick-hcl/functions/all).
