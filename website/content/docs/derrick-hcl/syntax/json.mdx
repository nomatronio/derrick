---
layout: docs
page_title: JSON Syntax - derrick.hcl
description: |-
  Derrick configuration is usually written in [HCL syntax](/derrick/docs/derrick-hcl/syntax) which is designed to be relatively easy for humans to read and update. Derrick also supports JSON. This syntax is useful when generating configurations programmatically, since existing JSON libraries can be used to prepare the generated configuration files.
---

# JSON Configuration Syntax

Derrick configuration is usually written in [HCL syntax](/derrick/docs/derrick-hcl/syntax)
which is designed to be relatively easy for humans to read and update. Derrick
...
Derrick expects HCL syntax to be in `derrick.hcl` and JSON syntax to
be in `derrick.hcl.json`. If both files exist, `derrick.hcl` will be
...
At the root of any JSON-based Derrick configuration is a JSON object. The
properties of this object correspond to the top-level [stanza types](/derrick/docs/derrick-hcl/syntax#stanzas).
For example:
...
[expression syntax](/derrick/docs/derrick-hcl/syntax/expressions), JSON values
interpreted as expressions are mapped as follows:

| JSON    | Derrick HCL Syntax Interpretation                                                                            |
| ------- | ------------------------------------------------------------------------------------------------------------- |
...
[string template]: /derrick/docs/derrick-hcl/syntax/expressions#string-templates
...
ignored by Derrick entirely. This exception does _not_ apply to objects
...
```json
{
  "//": "This file is generated by generate-derrick.py. DO NOT HAND-EDIT!",
