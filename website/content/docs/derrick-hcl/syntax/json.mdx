...
description: |-
  Derrick configuration is usually written in [HCL syntax](/waypoint/docs/derrick-hcl/syntax) which is designed to be relatively easy for humans to read and update. Derrick also supports JSON. This syntax is useful when generating configurations programmatically, since existing JSON libraries can be used to prepare the generated configuration files.
---

# JSON Configuration Syntax

Derrick configuration is usually written in [HCL syntax](/waypoint/docs/derrick-hcl/syntax)
...
properties of this object correspond to the top-level [stanza types](/waypoint/docs/derrick-hcl/syntax#stanzas).
For example:
...
[expression syntax](/waypoint/docs/derrick-hcl/syntax/expressions), JSON values
...
[string template]: /waypoint/docs/derrick-hcl/syntax/expressions#string-templates
