...
The `plugin` stanza is **optional.** When you use a [`use`](/waypoint/docs/derrick-hcl/use)
...
- `type` <code>([type](/waypoint/docs/derrick-hcl/plugin#type-parameters): nil)</code> - The
