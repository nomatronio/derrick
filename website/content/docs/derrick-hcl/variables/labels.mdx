---
layout: docs
page_title: labels - Variables - derrick.hcl
description: |-
...
deployment to mirror the Derrick labels we have set.
...
prefix all our labels with "derrick/" to note they come from Derrick.
