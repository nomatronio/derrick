...
also be used to [fetch values from remote sources](/waypoint/docs/derrick-hcl/variables/dynamic).
...
> **Hands-on:** Try the [Input Variables](/waypoint/tutorials/configuration/input-variables)
> tutorial.

## Declaring an Input Variable

Each input variable referenced in the derrick.hcl file must be declared using a
[`variable` block](/waypoint/docs/derrick-hcl/variable). Example variable declaration
blocks include:
...
The name of a variable can be any valid [identifier](/waypoint/docs/derrick-hcl/syntax#identifiers).
...
[type of value](/waypoint/docs/derrick-hcl/syntax/expressions#types-and-values) that
...
from within [expressions](/waypoint/docs/derrick-hcl/syntax/expressions) as
...
[Top-level parameters](/waypoint/docs/derrick-hcl#top-level-parameters), such as the
...
- In the project settings via [the Derrick server's UI](/waypoint/docs/server#waypoint-server).
...
as default values on the Derrick [runner](/waypoint/docs/runner).
...
[literal expressions](/waypoint/docs/derrick-hcl/syntax/expressions#literal-expressions)
...
- In the project settings via [the Derrick server's UI](/waypoint/docs/server).
- Automatically loaded variable definition files, named with the pattern
  `*.auto.wpvars`.
