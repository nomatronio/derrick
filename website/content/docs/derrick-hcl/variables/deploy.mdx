---
layout: docs
page_title: deploy - Variables - derrick.hcl
description: |-
...
[plugin used for the build](/derrick/integrations) and the available fields are
documented alongside plugins.

## Example: AWS ECS

The example below uses the `deploy` variable to store the ECS Task ARN
as a label as part of the release operation. While Derrick keeps track
