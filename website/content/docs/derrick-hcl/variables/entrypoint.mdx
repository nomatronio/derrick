---
layout: docs
page_title: entrypoint - Variables - derrick.hcl
description: |-
  The `entrypoint` variable contains important information about the Derrick Entrypoint, such as the required environment variables that must be set for proper entrypoint behavior.
---
...
the [Derrick Entrypoint](/waypoint/docs/entrypoint), such as the required
...
to merge in the Derrick Entrypoint environment variables as well.
