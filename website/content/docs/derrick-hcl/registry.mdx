...
runner](/waypoint/docs/runner#cli-runner). This is not the common case, and thusly almost
always a `registry` stanza should be used.

Please see the documentation on the
[registry phase of the Derrick lifecycle](/waypoint/docs/lifecycle/build#registry)
