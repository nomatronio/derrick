---
layout: docs
page_title: registry - derrick.hcl
description: |-
...
runner](/derrick/docs/runner#cli-runner). This is not the common case, and thusly almost
always a `registry` stanza should be used.

Please see the documentation on the
[registry phase of the Derrick lifecycle](/derrick/docs/lifecycle/build#registry)
for examples of when a registry is necessary and the behavior of Derrick without a
registry specified.
