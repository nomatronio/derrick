---
layout: docs
page_title: release - derrick.hcl
description: |-
...
[release phase of the Derrick lifecycle](/derrick/docs/lifecycle/release)
for the Derrick behavior when a release phase is not configured.
