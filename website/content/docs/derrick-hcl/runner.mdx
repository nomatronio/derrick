...
`runner `stanza can also be specified using the [`derrick project apply`](/waypoint/commands/project-apply)
...
CLI using [`derrick project apply`](/waypoint/commands/project-apply) or via
...
[data_source]: /waypoint/docs/derrick-hcl/config#data_source-parameters 'data_source Stanza'
[poll]: /waypoint/docs/derrick-hcl/config#poll-parameters 'poll Stanza'
