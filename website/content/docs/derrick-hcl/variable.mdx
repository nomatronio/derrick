---
layout: docs
page_title: variable - derrick.hcl
description: |-
...
[defining and using variables here](/waypoint/docs/derrick-hcl/variables/input).
...
- `env` `(list of string: [])` - Sets a set of environment variables to source
  ...
  only on the runner. See [environment variables](/waypoint/docs/derrick-hcl/variables/input#environment-variables) for more information.

[expression]: /waypoint/docs/derrick-hcl/syntax/expressions#types-and-values 'Expressions: Types and Values'
