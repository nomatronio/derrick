...
[defining and using variables here](/derrick/docs/derrick-hcl/variables/input).
...
- `env` `(list of string: [])` - Sets a set of environment variables to source
  ...
  only on the runner. See [environment variables](/derrick/docs/derrick-hcl/variables/input#environment-variables) for more information.

[expression]: /derrick/docs/derrick-hcl/syntax/expressions#types-and-values 'Expressions: Types and Values'
