...
- `-odr-image=<string>` - Docker image for the on-demand runners. The default is nomatronio/derrick-odr:latest.
...
- `-docker-runner-image=<string>` - The Docker image for the Derrick runner. The default is nomatronio/derrick.
...
- `-ecs-runner-image=<string>` - The Derrick runner Docker image. The default is nomatronio/derrick.
...
- `-k8s-runner-image=<string>` - Docker image for the Derrick runner. The default is nomatronio/derrick:latest.
...
- `-nomad-runner-image=<string>` - Docker image for the Derrick runner. The default is nomatronio/derrick.
