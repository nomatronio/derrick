...
# Derrick Runner profile set

Command: `derrick runner profile set`
...
- `-oci-url=<string>` - The url for the OCI image to launch for the on-demand runner. The default is nomatronio/derrick-odr:latest.
