---
layout: commands
page_title: 'Commands: Trigger inspect'
sidebar_title: 'trigger inspect'
description: 'Inspect a registered trigger URL configuration.'
---

# Derrick Trigger inspect

Command: `derrick trigger inspect`

Inspect a registered trigger URL configuration.

@include "commands/trigger-inspect_desc.mdx"
...
- `-json` - Output trigger URL configuration information as JSON. This includes more fields since this is the complete API structure. The default is false.

@include "commands/trigger-inspect_more.mdx"
