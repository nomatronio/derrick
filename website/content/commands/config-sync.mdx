...
description: 'Synchronize declared variables and pipeline configs in a derrick.hcl'
---

# Derrick Config sync

Command: `derrick config sync`

Synchronize declared variables and pipeline configs in a derrick.hcl
