...
description: 'Inspect an On-Demand Runner Task from Derrick'
---

# Derrick Task inspect

Command: `derrick task inspect`

Inspect an On-Demand Runner Task from Derrick

@include "commands/task-inspect_desc.mdx"
...
@include "commands/task-inspect_more.mdx"
