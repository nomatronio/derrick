...
These parameters are used in `dynamic` for sourcing [configuration values](/derrick/docs/app-config/dynamic) or [input variable values](/derrick/docs/derrick-hcl/variables/dynamic).
