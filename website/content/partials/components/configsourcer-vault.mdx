...
These parameters are used in `dynamic` for sourcing [configuration values](/waypoint/docs/app-config/dynamic) or [input variable values](/waypoint/docs/derrick-hcl/variables/dynamic).
